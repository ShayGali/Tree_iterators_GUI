...
CXXFLAGS      = -pipe -std=c++2a -g -O2 -Wall -W -D_REENTRANT -fPIC $(DEFINES)
...
COMPRESS      = gzip -9f
DISTNAME      = main1.0.0
DISTDIR = /home/shayg/sp2/assignments/ex4/.tmp/main1.0.0
LINK          = g++
LFLAGS        = -Wl,-O1
...
moc_predefs.h: /usr/lib/x86_64-linux-gnu/qt5/mkspecs/features/data/dummy.cpp
	g++ -pipe -std=c++2a -g -O2 -Wall -W -dM -E -o moc_predefs.h /usr/lib/x86_64-linux-gnu/qt5/mkspecs/features/data/dummy.cpp
